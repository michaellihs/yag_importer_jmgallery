 ...
 */
class Tx_YagImporterJmgallery_Domain_Import_JmGalleryImporter {

	/**
	 * Some constants for using t3registry as mapping for jm_gallery UIDs
	 * on yag object UIDs.
	 */
	const REGISTRY_CATEGORY_MAPPING = 'tx_yag_importer_jmgallery_category_mapping';
	const REGISTRY_ALBUM_MAPPING = 'tx_yag_importer_jmgallery_album_mapping';
	const REGISTRY_IMAGE_MAPPING = 'tx_yag_importer_jmgallery_image_mapping';
	...
	protected function getJmImagesByAlbumUid($albumUid) {
        ...
        // TODO add order by according to sorting of images
	...
	protected function mapImageRowOnItem($imageRow, Tx_Yag_Domain_Model_Item $item, $imageBasePath, Tx_Yag_Domain_Model_Album $album) {
        ...
        // TODO import filesize from imported image
	}
